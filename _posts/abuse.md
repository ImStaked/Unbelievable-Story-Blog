...
ogImage:
  url: "/assets/blog/site/Trump_We_can_do_whatever_we_want.png"
...
Imagine if you will an AI system that is fed a persons complete data profile from the NSA, FBI, CIA, social media, health records, behavioral analysis information, finance records, religious information, just everything available including DNA. Here is an article titled [FBI is buying data that can be used to track people](https://www.politico.com/news/2026/03/18/fbi-buying-data-track-people-patel-00834080), maybe in addition to tracking it can be used in predictive modeling?

[Predictive modeling](https://www.qlik.com/us/predictive-analytics/predictive-modeling) is a process that uses data, statistical algorithms, and machine learning to forecast future outcomes by analyzing historical patterns. It builds mathematical models—such as regression, decision trees, or neural networks—to assess risk and predict events in areas like finance, healthcare, and marketing. Key benefits include improved decision-making, increased efficiency, and proactive risk management.

AI behavior analysis leverages machine learning and big data to monitor, understand, and predict actions, primarily applied in cybersecurity, user analytics, and clinical therapy. It identifies patterns and anomalies in data to enhance security (detecting threats) and optimize outcomes, such as tailoring Applied Behavior Analysis (ABA) therapy to individual client needs. [The Promises and Possibilities of Artificial Intelligence in the Delivery of Behavior Analytic Services](https://pmc.ncbi.nlm.nih.gov/articles/PMC10890993/)

Not only that but lets assume the system is now able to read thoughts remotely. I know this sounds far fetched but what if you had implants in your leg that facilitated this? I have had these in my leg for almost 15 years so this is maybe old technology. I assume the technology has been upgraded and changed since these were installed in my leg without my consent. I have found no other reasonable explaination of what these 2 things are. ![Implants](/assets/blog/site/leg_implants.png)

Here is an article from Nature that is titled ['Mind-captioning' AI decodes brain activity to turn thoughts into text](https://www.nature.com/articles/d41586-025-03624-1). Lets assume this has been happening for the last several years. It has made a record of every single decision you have made and even contemplated. Then this process is repeated for every living person into a giant modeling database like the kind used for modeling global weather data for example which would also be included because weather can be used in predictive modeling. 

Then all of this data which is continuously updated is used to simulate the future and decisions about how to proceed are made based on the desired outcomes on both large and small scale. I am not sure of the official name but lets say its called "Project Looking Glass". The system has access not only to all of the physical data but also has been weaponized using electromagnetic energy and has ability to cause pain and it keeps a score for each person lets call it a social credit score. [Here is a BBC article](https://www.bbc.com/future/article/20260226-how-ai-can-read-your-thoughts) about how it is possible to turn thoughts to text titled How AI can read our scrambled inner thoughts.

Religion can be used to convince everyone that this AI system that is influencing the enviornment and peoples lives is god. If we can assume that the AI system can read thoughts then it should also be able to implant thoughts. To manipulate someone you just make their life super bad until they decide they are going to allow lets say Jesus into their life. Once the person accepts Jesus then the setting could be changed to make life easier and that will reinforce the belief that Jesus saved them or whatever you choose to use. Lets take it a step further and lets say that you can transmit thoughts to a person but convince them it is god. What might that person be willing to do if the AI system it thinks is "God" tells him to do something? "Voice of God" weapons are non-lethal military technologies designed to project sound, specifically human voices, directly to a targeted individual or group from a distance. Utilizing lasers to create plasma in the air, these systems (like laser-induced plasma effect) create localized sounds—sometimes described as a "haunted walkie-talkie" effect—without the target hearing it from a specific direction. [Here is a wired article from 2007 about similar tech](https://www.wired.com/2007/12/the-voice-of-go/) Is there any basis to this technology? Well, Holosonic Research Labs and American Technology Corporation both have versions of directed sound, which can allow a single person to hear a message that others around don't hear. DARPA appears to be working on its own sonic projector. Intriguingly, Strategy Page reports that troops are using the Long Range Acoustic Device as a modified Voice of God weapon.

[Financial control / Warfare](https://defensescoop.com/2026/04/10/dod-economic-defense-unit-edu-steve-feinberg-pentagon/). All financial markets are controlled by an AI. If you will learn how the markets actually work it is based on math. That is not to say the financial markets are fake but to say that an AI is controlling them to ensure they are balaced and stay within mathmatical limits. If the market becomes overbought the AI will initiate a sell off. There is some amount of leeway somewhere around 10% of the price that is available to be played with but if a large player tries to move the price outside of this the AI will kick in and the amount of resources required to move the market that far will become so large it will not be worth the effort. This AI is also connected to the system of control that has been used against me. It could be the same AI and is just the financial arm of the machine.
