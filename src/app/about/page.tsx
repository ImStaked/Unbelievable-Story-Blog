    ...
    <div className="container mx-auto px-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-lg leading-relaxed mb-4">
            My technical work, which you can find on my GitHub, is focused on blockchain infrastructure and services. I enjoy getting my hands dirty with code and understanding how these systems work from the inside out.
          </p>
          <div>
