    ...
    <div className="container mx-auto px-5 py-8 md:py-12">
      <section className="flex flex-col items-center text-center">
        ...
        <div className="max-w-3xl mx-auto text-lg md:text-xl leading-relaxed mb-6">
          <p>
            Welcome to My Unbelievable Story. What you are about to read is the result of years being abused by weird electronic weapons while trying to fix my life and working in the crypto industry. This is a world of shadows, where things are rarely as they appear. Behind the lofty promises of decentralization and innovation lie intricate networks of influence, questionable ethics, and hidden agendas.
          </p><br></br>
